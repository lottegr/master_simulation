...
plt.figure(1)
# # u-turn
# plt.plot([x0,x0],[y0,2.6],'r--', label='reference')
...
plt.figure(3)
# # u-turn
# plt.plot(range(t[0],t[1]), [i-x0 for i in plots['x0']], 'purple', label='x')
# plt.plot(range(t[1],t[2]), [i-x0 for i in plots['x1']], 'purple')
